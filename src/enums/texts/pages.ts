export enum PagesTexts {
  TITLE = "Where's my money?!",
  SUBTITLE = "Application to help you manage your home budget",
  ...
  CAN_NOT_CHANGE_PROFILE = "You are sign in with Google account. You can't change your profile data from here.",
